...
export let texture_definitions: TextureDefinition[] = [
    ...
    [TEXTURE_TYPE_SPRITE_STRIP,
        [TEXTURE_WHITE_CIRCLE, TEXTURE_D_PAD, TEXTURE_ROBED_MAN, TEXTURE_BANDIT, TEXTURE_SKELETON, TEXTURE_ZOMBIE, TEXTURE_BAT, TEXTURE_SNAKE, TEXTURE_WALL, TEXTURE_FLOOR],
        0, 16, 16, 16],
];
